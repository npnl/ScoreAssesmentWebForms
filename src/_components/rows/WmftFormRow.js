		...
		if (this.state.separator === true) {
			...
			row = (
				<tr>
					...
					<td><input type="number" min="0" max="120" value={this.state.time} placeholder="Time in seconds" onChange={this.handleTimeChange} disabled={this.state.disabled} className={this.state.disabled ? 'disabled-input': ''}/></td>
